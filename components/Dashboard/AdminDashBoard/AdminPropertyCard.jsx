...
const AdminPropertyCard = ({ item, key }) => {
    ...
    <div className="row d-flex align-items-center">
      ...
      <div className="col">
        ...
        {(item._isApproved &&
              ...
              item._ticketBuyerInfo._PropertyPricePaid && !item._ticketBuyerInfo.DealAccepted) && (
          <>
            <GoPrimitiveDot className="text-success" /> Propety Bought
          </>
        )}
        {(item._isApproved &&
              item._isTicketCreated &&
              ...
              item._ticketBuyerInfo._PropertyPricePaid && item._ticketBuyerInfo.DealAccepted) && (
          <>
            <GoPrimitiveDot className="text-success" /> Property Bought
          </>
        )}
      </div>

      <div className="col text-end">
        <AdminPropertyDetails imagesList={imagesList} item={item} />
      </div>
    </div>
  </div>
  );
